...
def main(argv):
    ...
    parser.add_argument(
        "--output_directory",
        default="/home/shanhai/outputs/atiss/bedrooms",
        help="Path to output directory"
    )
    parser.add_argument(
        "--path_to_3d_front_dataset_directory",
        default="/home/shanhai/datasets/3D-FRONT",
        help="Path to the 3D-FRONT dataset"
    )
    parser.add_argument(
        "--path_to_3d_future_dataset_directory",
        default="/home/shanhai/datasets/3D-FUTURE-model",
        help="Path to the 3D-FUTURE dataset"
    )
    parser.add_argument(
        "--path_to_model_info",
        default="/home/shanhai/datasets/3D-FUTURE-model/model_info.json",
        help="Path to the 3D-FUTURE model_info.json file"
    )
    parser.add_argument(
        "--path_to_floor_plan_textures",
        default="/home/shanhai/mycode/myATISS-master/demo/floor_plan_texture_images",
